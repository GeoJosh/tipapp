...
class ApplicationCreationRequest:
    def __init__(self, first_name: str, last_name: str, venmo_username: str, email: str, employer: str, verification_information: str) -> None:
        self.first_name = first_name
        self.last_name = last_name
        self.venmo_username = venmo_username
        self.email = email
        self.employer = employer
        self.verification_information = verification_information
...
class ApplicationCreationRequestSchema(Schema):
    ...
    verification_information = fields.String(required=True)
